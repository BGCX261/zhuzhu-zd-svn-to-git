Public Class Gallery
    ...
    Public Overrides ReadOnly Property Url() As String
        Get
            ...
            Return Common.Functions.Current.GetUrlbyRegex(Me.Container.ActionConfig("gallery_single").Value, PathRegexConfig)
        End Get
    End Property
    ...
    Public Function JoinTags(Optional ByVal Delimiter As String = " ") As String
    ...
    Public Overrides Property Meta() As Common.ItemConfig(Of Common.Item)
        Get
            ...
            If FPermaLink <> String.Empty Then
                Dim xf As New Common.XmlSerialize(Of String)
                Dim s As String = xf.Serialize(FPermaLink)
                MyBase.Meta.Add(New Common.Item("PermaLink", s))
            End If
        ...
        Set(ByVal value As Common.ItemConfig(Of Common.Item))
            ...
            If MyBase.Meta.ContainsKey("PermaLink") = True Then
                Dim xf As New Common.XmlSerialize(Of String)
                FPermaLink = xf.DeSerialize(MyBase.Meta("PermaLink").Value)
            End If
