Public Class Share
    ...
    Public Overrides ReadOnly Property Url() As String
        Get
            ...
            Return Common.Functions.Current.GetUrlbyRegex(Me.Container.ActionConfig("share_single").Value, PathRegexConfig)
        End Get
    End Property
