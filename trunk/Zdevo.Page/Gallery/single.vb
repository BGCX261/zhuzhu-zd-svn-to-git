Namespace [Gallery]
    Public Class [Single]
        ...
        Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
            ...
            Zdevo.Common.Utility.Current.Trace.Write("进入gallery singles处理程序")

            Dim b As Boolean
            b = Me.System_Initialize

            Dim postlist As Zdevo.Core.SQLite.GalleryList = Container.GetGalleryList
            Dim post As Zdevo.Core.SQLite.Gallery = Nothing
            ...
            HeadTitle = post.Name
            ColumnNow = Me.Container.Site.Columns("gallery").Name
            ...
            Me.LoadXSLT(Zdevo.Common.Utility.Current.MapPath("~\theme\default\template\gallery_single.xsl"))
