Namespace [Bookmark]
    Public Class [Single]
        ...
        Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
            ...
            Zdevo.Common.Utility.Current.Trace.Write("进入bookmark singles处理程序")

            Dim b As Boolean
            b = Me.System_Initialize

            Dim postlist As Zdevo.Core.SQLite.BookmarkList = Container.GetBookmarkList
            Dim post As Zdevo.Core.SQLite.Bookmark = Nothing
            ...
            HeadTitle = post.Name
            ColumnNow = Me.Container.Site.Columns("bookmark").Name
            ...
            Me.LoadXSLT(Zdevo.Common.Utility.Current.MapPath("~\theme\default\template\bookmark_single.xsl"))
