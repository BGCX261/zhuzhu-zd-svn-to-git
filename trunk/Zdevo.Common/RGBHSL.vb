Public Class RGBHSL
    ...
    Public Class HSL
        ...
        Public Property H() As Double
            ...
            Set(ByVal value As Double)
                ...
                _h = CDbl(IIf(_h > 1, 1, IIf(_h < 0, 0, _h)))
        ...
        Public Property S() As Double
            ...
            Set(ByVal value As Double)
                ...
                _s = CDbl(IIf(_s > 1, 1, IIf(_s < 0, 0, _s)))
        ...
        Public Property L() As Double
            ...
            Set(ByVal value As Double)
                ...
                _l = CDbl(IIf(_l > 1, 1, IIf(_l < 0, 0, _l)))
    ...
    Public Shared Function HSL_to_RGB(ByVal hsl As HSL) As Color
        ...
        Else
            ...
            Else
                ...
                temp2 = CDbl(IIf(hsl.L <= 0.5, hsl.L * (1.0 + hsl.S), hsl.L + hsl.S - hsl.L * hsl.S))
    ...
    Public Shared Function AntiColor(ByVal c As Color) As Color

        Return System.Drawing.Color.FromArgb(255 - c.R, 255 - c.B, 255 - c.G)
