Public Class Bookmark
    ...
    Public Overrides ReadOnly Property Url() As String
        Get
            ...
            Return Common.Functions.Current.GetUrlbyRegex(Me.Container.ActionConfig("bookmark_single").Value, PathRegexConfig)
        End Get
    End Property
