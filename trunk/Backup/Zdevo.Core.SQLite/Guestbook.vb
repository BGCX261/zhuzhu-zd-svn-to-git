Public Class Guestbook
    ...
    Public Overrides Property NodeString() As String
        Get
            If String.IsNullOrEmpty(MyBase.NodeString) Then
                ...
                wr.WriteStartElement("guestbook")
                ...
                wr.WriteElementString("note", Me.Note)
    ...
    Public Overrides ReadOnly Property Url() As String
        Get
            ...
            Return Common.Functions.Current.GetUrlbyRegex(Me.Container.ActionConfig("guestbook_single").Value, PathRegexConfig)
        End Get
    End Property
    ...
    Public Overrides Property Type() As Core.PostType
        Get
            Return Core.PostType.Guestbook
        End Get
