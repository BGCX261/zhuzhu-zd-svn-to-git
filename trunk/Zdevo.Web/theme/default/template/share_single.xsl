		...
		<html>
			<head>
				...
				<xsl:element name="link">
					...
					<xsl:attribute name="href"><xsl:value-of select="//data/site/config/variable[@name='SITE_HOST']" />theme/<xsl:value-of select="//data/site/config/variable[@name='SITE_TEMPLATE']" />/code/Css.ashx?color=darksalmon</xsl:attribute>
			...
			<body class="share single share-single">
				<div id="divAll">
					<div id="divPage">
					<div id="divMiddle">
...
<xsl:apply-templates select="data/share" />
...
<!-- 文章输出区 -->
	<xsl:element name="div">
		...
		<h6 class="post-footer">
			<xsl:value-of select="user/name" />&#000032;&#000032;于&#000032;<xsl:value-of select="postdatetime" />&#000032;分享
		</h6>
	</xsl:element>
