		...
		<html>
			<head>
				...
				<xsl:element name="link">
					...
					<xsl:attribute name="href"><xsl:value-of select="//data/site/config/variable[@name='SITE_HOST']" />theme/<xsl:value-of select="//data/site/config/variable[@name='SITE_TEMPLATE']" />/code/Css.ashx?color=cornflowerblue</xsl:attribute>
			...
			<body class="blog single blog-single">
				<div id="divAll">
					<div id="divPage">
					<div id="divMiddle">
